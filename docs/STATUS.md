...
Дата: 2026-09-13 (обновлено: пулы v4, история, трейдеры, CJK, семантика)
...
| ~~Семантический слой~~ — сделано, кроме категорий из фиксированной таксономии (zero-shot по якорям эмбеддингов); LLM-именование не проверено вживую, нужен ключ | | |
