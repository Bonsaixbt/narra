...
- **Hosting: Cloudflare Pages**, connected to the GitHub repository; every push to the site's branch deploys automatically, pull requests get preview URLs. No Vercel.
