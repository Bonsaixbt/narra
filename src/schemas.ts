...
export const ClusterHistoryOut = z.object({ slug: z.string(), id: z.string().nullable().optional(), window: z.enum(["15m", "60m", "4h"]).optional(), hours: z.number(), reading: z.string().optional(), snapshots: z.array(z.object({ ts: z.string(), ts_unix: z.number(), window: z.string(), status: z.string(), id: z.string().nullable().optional(), n_launches: z.number(), quote_eth: z.number(), buyers: z.number(), graduations: z.number(), members: z.number() })) });
