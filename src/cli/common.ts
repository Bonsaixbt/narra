...
export function open(args: Args): { n: Narra; q: QueryOptions; done: (p: import("../ingest/sync.js").SyncProgress) => void } {
  ...
  const q: QueryOptions = { window, pair, members: !!args.flags.members, top: Number(str(args.flags.top) ?? 0) || undefined, noSync: !!args.flags.offline, onProgress: rep?.onProgress };
