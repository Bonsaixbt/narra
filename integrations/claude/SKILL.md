...
| "who is rotating / which wallets are early" | `narra wallets --cohort rotator --json` (flow wallet clusters, never a follow signal) |
...
If `narra` is not installed: `npx -y narrahood <command>`.
